...
parser.add_argument('--apec_val_plugin_ratio', type=float, default=0.5, help='fraction of official val used to train APEC plug-in')
parser.add_argument('--apec_val_gamma_ratio', type=float, default=0.25, help='fraction of official val used to select APEC gamma')
...
parser.add_argument('--apec_delta_l2', type=float, default=0.01, help='L2 penalty for APEC delta correction')
parser.add_argument('--apec_plugin_patience', type=int, default=3, help='early stopping patience for APEC plug-in')
